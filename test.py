...
def calc_wins():
    ...
    with open('test log.txt', 'a') as f:
        print("50 games, 2 second time limit, random player", file=f)
    ...
    for i in range(20):
        ...
        gc.collect()
    with open('test log.txt', 'a') as f:
        print("50 games, 5 second time limit, random player", file=f)
        print(f"x has won {dark_wins}", file=f)
        print(f"o has won {white_wins}", file=f)
        print(f"{ties} games has been tied", file=f)
    for i in range(20):
        ...
        gc.collect()
    with open('test log.txt', 'a') as f:
        print("50 games, 10 second time limit, random player", file=f)
        print(f"x has won {dark_wins}", file=f)
        print(f"o has won {white_wins}", file=f)
        print(f"{ties} games has been tied", file=f)
    for i in range(20):
        ...
        gc.collect()
    with open('test log.txt', 'a') as f:
        print("50 games, 2 second time limit, simple player", file=f)
        print(f"x has won {dark_wins}", file=f)
        print(f"o has won {white_wins}", file=f)
        print(f"{ties} games has been tied", file=f)
    for i in range(20):
        ...
        gc.collect()
    with open('test log.txt', 'a') as f:
        print("50 games, 5 second time limit, simple player", file=f)
        print(f"x has won {dark_wins}", file=f)
        print(f"o has won {white_wins}", file=f)
        print(f"{ties} games has been tied", file=f)
    for i in range(20):
        ...
        gc.collect()
    with open('test log.txt', 'a') as f:
        print("20 games, 2 second time limit, simple player", file=f)
        print(f"x has won {dark_wins}", file=f)
        print(f"o has won {white_wins}", file=f)
        print(f"{ties} games has been tied", file=f)
